...
class LayerwiseBlockES:
    ...
    def _per_block_ea(self, fixed_ops, fixed_wds, b_idx, inputs, baseline_swap):
        ...
        for _ in range(self.population_size):
            ...
            pop.append({"op_gene": op_gene, "wd_gene": wd_gene, "fitness": fitness_abs,
                        "absolute_swap": abs_swap, "params_mb": params_mb})
        ...
        for g in range(self.n_generations):
            ...
            while len(next_gen) < self.population_size:
                ...
                child["fitness"], child["absolute_swap"], child["params_mb"] = fitness_abs, abs_swap, params_mb
